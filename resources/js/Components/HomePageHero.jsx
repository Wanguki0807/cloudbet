    ...
    <>
        <section>
            <div className='h-[100svh] relative'>
                ...
                <div className='absolute  top-0 bottom-0 right-0 left-0 flex gap-[4rem] items-center justify-center flex-col'>
                    <div>
                        <h2 className='text-brand-text-color font-extrabold uppercase text-5xl text-center'>
                            #1 crypto  
                    ...
                    <div>
                    <Link href="http://www.trustpilot.com/review/www.cloudbet.com" target="_blank" class="flex flex-col items-center justify-center md:flex-row text-brand-text-color">
